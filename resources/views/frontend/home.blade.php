                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            ...
                            <h2>${{ $product_item->product_price }}</h2>
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                ...
                                <a href="{{ route('view-product',['product_id'=>$product_item->product_id]) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="choose">
                        <ul class="nav nav-pills nav-justified">
                            ...
                            <li><a href="{{ route('view-product',['product_id'=>$product_item->product_id]) }}"><i class="fa fa-plus-square"></i>View Product</a></li>
                        </ul>
                    </div>
                </div>
            </div>
